...
for ( i = 0 ; i < 1;i++){
SEND(s01_0,20,MPI_INT,sezioni[1].rank,7,MPI_COMM_WORLD);
SEND(s10_0,20,MPI_INT,sezioni[3].rank,5,MPI_COMM_WORLD);
SEND(s12_0,20,MPI_INT,sezioni[5].rank,3,MPI_COMM_WORLD);
SEND(s21_0,20,MPI_INT,sezioni[7].rank,1,MPI_COMM_WORLD);
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
RECEIVE(o01,20,MPI_INT,sezioni[1].rank,1,MPI_COMM_WORLD,&status);
...
RECEIVE(o21,20,MPI_INT,sezioni[7].rank,7,MPI_COMM_WORLD,&status);
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s00_1[i0][i1] = MACRO( s01_0[i0+0][i1+1],s10_0[i0+1][i1+0],o01[i0+0][i1+0],o10[i0+0][i1+0]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s02_1[i0][i1] = MACRO( o12[i0+0][i1+0],s12_0[i0+1][i1+0],o01[i0+0][i1+19],s01_0[i0+0][i1+18]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 18 ; i0 <=18;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s12_1[i0][i1] = MACRO( o12[i0+0][i1+0],s22_0[i0-18][i1+0],s12_0[i0-1][i1+0],s11_0[i0-1][i1+17]);
	}
}
for (i0 = 19 ; i0 <=19;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s20_1[i0][i1] = MACRO( s21_0[i0+0][i1+1],o21[i0+0][i1+0],s10_0[i0+18][i1+0],o10[i0+19][i1+0]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
	...
	for (i1 = 18 ; i1 <=18;i1++){
		s21_1[i0][i1] = MACRO( s22_0[i0+0][i1-18],o21[i0+0][i1+0],s11_0[i0+17][i1-1],s21_0[i0+0][i1-1]);
	}
	for (i1 = 19 ; i1 <=19;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s22_1[i0][i1] = MACRO( o12[i0+19][i1+0],o21[i0+0][i1+19],s12_0[i0+18][i1+0],s21_0[i0+0][i1+18]);
	}
}
SEND(s01_1,20,MPI_INT,sezioni[1].rank,7,MPI_COMM_WORLD);
SEND(s10_1,20,MPI_INT,sezioni[3].rank,5,MPI_COMM_WORLD);
SEND(s12_1,20,MPI_INT,sezioni[5].rank,3,MPI_COMM_WORLD);
SEND(s21_1,20,MPI_INT,sezioni[7].rank,1,MPI_COMM_WORLD);
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s00_0[i0][i1] = MACRO( s01_1[i0+0][i1+1],s10_1[i0+1][i1+0],o01[i0+0][i1+0],o10[i0+0][i1+0]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s02_0[i0][i1] = MACRO( o12[i0+0][i1+0],s12_1[i0+1][i1+0],o01[i0+0][i1+19],s01_1[i0+0][i1+18]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 18 ; i0 <=18;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s12_0[i0][i1] = MACRO( o12[i0+0][i1+0],s22_1[i0-18][i1+0],s12_1[i0-1][i1+0],s11_1[i0-1][i1+17]);
	}
}
for (i0 = 19 ; i0 <=19;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s20_0[i0][i1] = MACRO( s21_1[i0+0][i1+1],o21[i0+0][i1+0],s10_1[i0+18][i1+0],o10[i0+19][i1+0]);
	}
}
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
	...
	for (i1 = 18 ; i1 <=18;i1++){
		s21_0[i0][i1] = MACRO( s22_1[i0+0][i1-18],o21[i0+0][i1+0],s11_1[i0+17][i1-1],s21_1[i0+0][i1-1]);
	}
	for (i1 = 19 ; i1 <=19;i1++){
...
for (i0 = 0 ; i0 <=0;i0++){
	for (i1 = 0 ; i1 <=0;i1++){
		s22_0[i0][i1] = MACRO( o12[i0+19][i1+0],o21[i0+0][i1+19],s12_1[i0+18][i1+0],s21_1[i0+0][i1+18]);
	}
}
}
#if DEBUG
